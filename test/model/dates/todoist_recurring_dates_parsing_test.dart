...
void main() {
  ...
  void everyMonthTest(String str,
    ...
    final otherDates = parseRecurringTimeString(
      str,
      nextDateTime: nextDateTime,
      now: now,
  ...
  test(
      'every month when the specified date of month does not occur in each month',
      () {
    everyMonthTest(
      'monthly on 30',
